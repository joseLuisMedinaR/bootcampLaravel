                    ...
                    <form action="{{ route('chirps.store')}}" method="POST">
                        ...
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600" >
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea name='message' id="message" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Escriba su mensaje ..." required>{{ old('message')}}</textarea>
                            </div>
                        </div>
                        <x-input-error :messages="$errors->get('message')" class="font-bold mb-4"/>
                    ...
                    <div class="p-6 flex space-x-2">
                        ...
                        @can('update', $chirp)
                            <x-dropdown>
                                <x-slot name="trigger">
                                    <button>
                                        <svg class="w-5 h-5 text-gray-400 dark:text-gray-200" data-slot="icon" aria-hidden="true" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" stroke-linecap="round" stroke-linejoin="round"></path>
                                          </svg>                                        
                                    </button>
                                </x-slot>
                                <x-slot name="content">
