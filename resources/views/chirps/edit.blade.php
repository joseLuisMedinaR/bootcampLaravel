                    ...
                    <form action="{{ route('chirps.update', $chirp)}}" method="POST">
                        ...
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600" >
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea name='message' id="message" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Escriba su mensaje ..." required>{{ old('message', $chirp->message)}}</textarea>
                            </div>
                        </div>
                        <x-input-error :messages="$errors->get('message')" class="font-bold mb-4"/>
                        <x-primary-button>{{__("Save")}}</x-primary-button>
                        <x-cancel-link-button>{{ __("Cancel") }}</x-cancel-link-button>
                    </form>
                </div>
            </div>
        </div>
